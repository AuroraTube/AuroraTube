import {
  CommentSkeleton,
  RelatedVideoSkeletonRow,
  SkeletonBar,
} from '@/components/skeletons/primitives'

/** Placeholder blocks that mirror WatchInfo / description / comments layout. */
export function WatchMetaSkeleton() {
  return (
    <div className="space-y-4" aria-busy="true" aria-label="メタデータを読み込み中">
      {/* Title + meta (WatchInfo) */}
      ...
      {/* Related (mobile only; desktop uses sidebar) */}
