...
export function PostAttachment({ attachment }: { attachment: ChannelPostAttachment }) {
  ...
  if (attachment.type === 'video') {
    ...
    return (
      <Link
        ...
        className="mt-3 flex gap-3 rounded-xl border border-line bg-surface p-2 transition hover:bg-chip"
      >
  ...
  if (attachment.type === 'poll') {
    return (
      <div className="mt-3 space-y-1.5 rounded-xl border border-line bg-surface p-3">
